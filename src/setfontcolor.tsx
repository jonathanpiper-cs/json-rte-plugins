...
const activeElement = (color: any) => {
    return { color: color, fontSize: "14px", fontWeight: "bold" }
}
const defaultElement = (color: any) => {
    return { color: color, fontSize: "14px" }
}

const ColorComponent = (props: { attributes?: any; children?: any; leaf?: any }) => {
    const { leaf } = props
    return (
...
const Droppy = (props: { list: any, name: string }) => {
    const { list } = props
    return (
